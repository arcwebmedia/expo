                ...
                <ScrollView>
                    <View style={{
                        ...
                        <View style={{ height: 80, width: 250 }}>
                            <Image style={{ height: 80, width: 190, }} source={require('./assets/Logo.png')} />

                        </View>
                        <View style={{ justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: 'white', height: 40, width: 40 }}>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 10, }}>
                        <Text style={{ color: 'white', fontSize: 17, }}>Hide&Seek is designed to automatically</Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>create new friend groups.It Works on the </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>premise of asimple bar game to interact </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>with many new people at once.After you </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>have met and scanned somebody's QR </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>code, we wait for a confirmed </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>connection.After a confirmed </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>connection is created,we automatically </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>assign you to group chat for shared </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>connections. We also suggest activites </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>for your new group periodically that you </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>can RSVP to.This takes away the work of </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>Schedulling activites with your new friend </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}> friends.</Text>
                    </View>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                        ...
                        <Text style={{ color: 'white', fontSize: 17, marginTop: 10 }}>Scan My QR Code</Text>
                    </View>

                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 30 }}>
                        <Image style={{ height: 80, width: 80, }} source={require('./icons/refferal.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginTop: 10 }}>$5 Referral bonus for each user</Text>
                    </View>
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20 }} >
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, }}>
                        <Text style={{ color: 'white', fontSize: 17, }}>You found us, so lets play this</Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>weekend.More than 1 Million people  </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>around the world already sharing the </Text>
                        <Text style={{ color: 'white', fontSize: 17, }}>same experience. </Text>
                    ...
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        ...
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Go To Web App</Text>
                    </View>
                    <View style={{ borderBottomWidth: 1, width: '80%', borderColor: 'white', alignSelf: 'center', marginTop: 10 }}></View>

                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Upload a photo so people can recognise you on
                            the night </Text>
                    </View>
                    <View style={{ borderBottomWidth: 1, width: '80%', borderColor: 'white', alignSelf: 'center', marginTop: 10 }}></View>
                    ...
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Update your venue name as you move
                    ...
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Look for people in the same venue as you
                    ...
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Help locate people through group chat for all
                    ...
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>If you recognise a participant ask to scan their QR
                    ...
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Cash prize is distributed at end of the night according to number
                            of points you have</Text>
                    </View>
                    <View style={{ borderBottomWidth: 1, width: '80%', borderColor: 'white', alignSelf: 'center', marginTop: 10 }}></View>
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Add people to your connection list through mutual
                    ...
                    <View style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'center', width: '80%', alignItems: 'center' }}>
                        <Image style={{ height: 25, width: 25, }} source={require('./assets/ok.png')} />
                        <Text style={{ color: 'white', fontSize: 17, marginLeft: 10 }}>Host public appearances for your fanbase</Text>
                    </View>
                    <View style={{ borderBottomWidth: 1, width: '80%', borderColor: 'white', alignSelf: 'center', marginTop: 10 }}></View>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, }}>
                        <Text style={{ color: 'white', fontSize: 15, }}>ENTERTAIN YOUR FANS WITH YOUR LIVELY </Text>
                        <Text style={{ color: 'white', fontSize: 15, }}>PERSONALITY, SCAN THEIR QR CODE.  </Text>
                    </View>
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 30, }}>
                        <Text style={{ color: 'white', fontSize: 15, }}>SHOW YOUR FANS A FUN TIME BY </Text>
                        <Text style={{ color: 'white', fontSize: 15, }}> SOCIALIZING WITH THEM AND LETTING YOUR </Text>
                        <Text style={{ color: 'white', fontSize: 15, }}> FANS SOCIALIZE WITH EACH OTHER. </Text>
                    </View>
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, }}>
                        <Text style={{ color: 'white', fontSize: 15, }}>MAKE SURE YOUR FANS HAVE A FUN NIGHT  </Text>
                        <Text style={{ color: 'white', fontSize: 15, }}>WITH DRINKS AND EPIC CONVERSATION SO  </Text>
                        <Text style={{ color: 'white', fontSize: 15, }}>THEY STAY LOYAL. </Text>
                    </View>
                    <View style={{
                    ...
                    <View style={{ justifyContent: 'space-between', alignItems: 'center', marginTop: 30, flexDirection: 'row', width: '90%', alignSelf: 'center' }}>
                        <Image style={{ height: 55, width: '48%', }} source={require('./assets/googlePlay.png')} />
                        <Image style={{ height: 55, width: '48%', }} source={require('./assets/AppStore.png')} />
                    </View>
                    ...
                    <View style={{ height: 430, width: '100%', backgroundColor: 'white', marginTop: 40, borderRadius: 10 }}>
                        ...
                        <View style={{
                            ...
                            <Text style={{fontSize:17,marginTop:10,color:'black'}}>Messege</Text>
                        </View>
